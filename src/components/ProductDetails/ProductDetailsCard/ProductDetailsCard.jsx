  ...
  return (
    <>
      <div className={style.ProductDetailsCard}>
        <img
          src="https://rukminim1.flixcart.com/image/960/1280/xif0q/headphone/o/t/w/tw121-pro-pods-upto-40-hrs-playtime-type-c-fast-charging-dual-original-imahj262yjbjghjd.jpeg?q=60"
          alt=""
        />
      ...
      <div className={style.Price}>
        <h5>Hectic</h5>
        <p>
          Black Earbuds With Premium Quality Sound Bluetooth Headset (Black..
          <a>more</a>)
        </p>
